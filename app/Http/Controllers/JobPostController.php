    ...
    public function store(Request $request)
    {
        if (Auth::check() && Auth::user()->role == 'employer') {
            ...
            $request->validate([
                ...
                'salary' => 'nullable|numeric|min:0', // Updated validation rule
                ...
                'salary.min' => 'Gaji Tidak Boleh Kurang dari 0', // Ensure this error message is present
                'salary.max' => 'Gaji Tidak Boleh Lebih dari 999999999',
